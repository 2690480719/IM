...
public class NewGroupActivity extends Activity {
    ...
    private void initListener() {
        ...
        bt_newgroup_create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(et_newgroup_name.getText())) {
                    Toast.makeText(NewGroupActivity.this, "群名称不能为空", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void createGroup(final String[] memberses) {
        ...
        Model.getInstance().getGlobalThreadPool().execute(new Runnable() {
            ...
            public void run() {
                // 去环信服务器创建群
                // 参数：一、群名称  二、群描述  三、群成员  四、原因  五、参数设置
                ...
                try {
                    EMClient.getInstance().groupManager().createGroup(
                                groupName, groupDesc, memberses, "申请加入群", options);
